...
두 수열 $\bigg\lbrace (x+2)\left(\dfrac{x}{3}\right)^n\bigg\rbrace$, $\bigg\lbrace x\left(\dfrac{x-2}{2}\right)^n\bigg\rbrace$이 모두 수렴하는 정수 $x$의 개수는? [4.2점]
...
직선 $2x-y+1=0$, $3x+5y+2=0$에 대하여 두 직선 위의 한 점을 각각 $A(0, 1), B(1, -1)$, 두 직선의 교점을 $C$라고 하자. 삼각형 $ABC$에서 $\angle C=\theta$라고 할 때, $\tan\theta$의 값은? [4.7점]
