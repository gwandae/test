...
12번 순열 조합 아래첨자 표기 오류 문제는 수정중 입니다.
...
$x$에 대한 이차방정식 ${_5}C_3x^2-\left(_3P_1\times\, _nC_r\right) x-\, _3C_1\times\, _nP_{n-r}=0$ 의 두 근이 $-3$과 $6$일 때, 자연수 $n, r$에 대하여 $n-r$의 값은? [5.5점]
