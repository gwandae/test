...
다음 식 $f(x)={_5}P{_3} + {_{10}}C{_9}$ 의 값은? [4점]
...
$x$에 대한 이차방정식 $\phantom{e}{_5}C{_3}x^2-({_3}P{_1}\times{_n}C{_r})x-{_3}C{_1}\times{_n}P{_{n-r}}=0$ 의 두 근이 $-3$과 $6$일 때, 자연수 $n, r$에 대하여 $n-r$의 값은? [5.5점]
