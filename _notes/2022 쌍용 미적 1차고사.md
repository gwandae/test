...
$\displaystyle\lim_{n\to\infty}\dfrac{(n+1)^3}{a_1\hspace{0em}^2+a_2\hspace{0em}^2+\cdots+a_n\hspace{0em}^2}$
...
|$<$조건$>$|
|---|
|(가) $\displaystyle\sum_{n=1}^\infty\bigg\lbrace a_n+\left(\dfrac{1}{3}\right)^n\bigg\rbrace=\displaystyle\sum_{n=1}^\infty b_n$|
